...
public class ModEntities {
	...
	public static final RegistryObject<EntityType<FriendlyVex>> FRIENDLY_VEX = ENTITY_TYPES.register("friendly_vex",
			() -> EntityType.Builder.of(FriendlyVex::new, MobCategory.MONSTER).fireImmune().sized(0.4F, 0.8F).clientTrackingRange(8).build("friendly_vex"));
	public static final RegistryObject<EntityType<FriendlyRavager>> FRIENDLY_RAVAGER = ENTITY_TYPES.register("friendly_ravager",
			() -> EntityType.Builder.of(FriendlyRavager::new, MobCategory.MONSTER).sized(1.95F, 2.2F).clientTrackingRange(10).build("friendly_ravager"));
	...
	public static void registerEntities(SpawnPlacementRegisterEvent event) {
		...
		event.register(FRIENDLY_VEX.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Monster::checkMonsterSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);
		event.register(FRIENDLY_RAVAGER.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Monster::checkMonsterSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);
	}
