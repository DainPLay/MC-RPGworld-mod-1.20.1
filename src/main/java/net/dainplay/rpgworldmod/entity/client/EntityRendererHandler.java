...
import net.dainplay.rpgworldmod.entity.client.render.FriendlyRavagerRenderer;
...
public class EntityRendererHandler {
	...
	public static void doSetup(FMLClientSetupEvent event) {
		...
		EntityRenderers.register(ModEntities.PRISMARINE_SHARD_PROJECTILE.get(), PrismarineShardRenderer::new);
	...
	public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(PrismarineShardModel.LAYER_LOCATION, PrismarineShardModel::createBodyLayer);
	...
	public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(ModEntities.FRIENDLY_VEX.get(), VexRenderer::new);
		event.registerEntityRenderer(ModEntities.FRIENDLY_RAVAGER.get(), FriendlyRavagerRenderer::new);
