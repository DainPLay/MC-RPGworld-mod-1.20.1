...
public class ModLootModifiers {
	...
	public static final RegistryObject<Codec<? extends IGlobalLootModifier>> REPLACE_ITEM_CHANCE =
			LOOT_MODIFIER_SERIALIZERS.register("replace_item_chance", ReplaceItemChanceModifier.CODEC);
