...
public class CancelScrollUsagePacket {
    private final int playerId;
    private final int targetId;

    public CancelScrollUsagePacket(int playerId, int targetId) {
        this.playerId = playerId;
        this.targetId = targetId;
    }

    public CancelScrollUsagePacket(FriendlyByteBuf buf) {
    ...
    public static void handle(CancelScrollUsagePacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
