...
public class ModBoatItem extends Item {
    ...
    public ModBoatItem(boolean chest, ModBoat.Type type, Item.Properties properties) {
        super(properties);
        this.chest = chest;
        this.type = type;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (result.getType() == HitResult.Type.MISS) {
            ...
            if (result.getType() == HitResult.Type.BLOCK) {
                ModBoat boat = this.getBoat(level, result);
    ...
    private ModBoat getBoat(Level level, HitResult result) {
        return this.chest ? new ModChestBoat(level, result.getLocation().x(), result.getLocation().y(), result.getLocation().z()) : new ModBoat(level, result.getLocation().x(), result.getLocation().y(), result.getLocation().z());
    }
}