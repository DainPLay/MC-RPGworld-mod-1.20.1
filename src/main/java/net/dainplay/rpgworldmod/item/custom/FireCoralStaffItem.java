...
public class FireCoralStaffItem extends StaffItem implements ChooseTargetItem {
	public FireCoralStaffItem(Properties properties) {
		super(properties);
	}
	...
	@Override
	public boolean highlightRandomItemInRadius(ItemStack stack, Player player) {
	...
	public float getX(ItemStack stack, Entity entity, boolean rightHand) {
		return rightHand ? 0.125F : 0.065F;
	}
