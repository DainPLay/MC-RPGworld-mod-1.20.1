...
public class BubbleCoralStaffItem extends StaffItem implements ChooseTargetItem {

	public BubbleCoralStaffItem(Properties properties) {
		super(properties);
	}
	...
	@Override
	public boolean highlightItemsInRadius(ItemStack stack, Player player) {
