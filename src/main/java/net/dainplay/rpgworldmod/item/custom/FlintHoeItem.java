...
public class FlintHoeItem extends HoeItem implements RPGtooltip, IgniteOnCritItem {
	public FlintHoeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
