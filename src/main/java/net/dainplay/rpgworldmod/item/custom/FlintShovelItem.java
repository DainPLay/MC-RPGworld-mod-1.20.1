...
public class FlintShovelItem extends ShovelItem implements RPGtooltip, IgniteOnCritItem {
	public FlintShovelItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
